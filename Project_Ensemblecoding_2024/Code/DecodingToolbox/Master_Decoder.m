...
switch config.mode
    ...
    case 'static_train_dynamic_test'
        % Calls function for static training and dynamic testing
        results = run_decoding_static_train_dynamic_test(decodingdata_train, decodingdata_test, config);
