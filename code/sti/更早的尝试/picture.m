...
%     else
    % 获得随机位置矩阵
        randomOrderL = randperm(9);
        randomSelectionL = randomOrderL(1:8);
        newgaborMatrix = gaborsRects(:, randomSelectionL);
        %获得随机方向矩阵
        randomOrderO = randi(18);
     
        ra = randperm(20)+randomOrderO*10-10;
        randomSelectionO = ra(1:8);
        Screen('DrawTextures', window, gabortex, [], newgaborMatrix, randomSelectionO, [], [], [], [],...
        ...
        recordmatrix2 = cat(3,recordmatrix2,recordmatrix1);
         ...
         filename = sprintf('square10_%d.jpeg', i);
         fullpath = fullfile('D:\Desktop\test\square10_33\', filename);
